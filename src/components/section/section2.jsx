        ...
        <Row className="sec2-column">
          ...
          <Col md={8} className="home-about-description">
            ...
            I&apos;ve embarked on an exciting <b>programming journey</b>, acquiring the necessary skills to create cutting-edge websites.
              ...
              <br />
              <br />
              As part of my continuous <b>learning journey</b>, I&lsquo;ve recently delved into <b>React</b> and <b>Redux</b> to further expand my skill set and keep myself at the forefront of the rapidly evolving tech landscape. With these tools in my arsenal, I&lsquo;m ready to take on the <b>challenges</b> and <b>opportunities</b> and beyond have to offer.
            </p>
          </Col>
        </Row>
      </Container>
